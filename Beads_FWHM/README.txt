...
### On a simulated PSF
One can use the PSF_Generator plugin [http://bigwww.epfl.ch/algorithms/psfgenerator/] to generate realistic PSF and run the macro on the generated image.
The bead size parameter should then be set to 0. 
